...
from model_3 import CNN_Model_3, get_optimizer as get_optimizer_3, get_optimizer_params as get_optimizer_params_3, get_train_transform, get_scheduler, get_scheduler_params
...
model_mapping = {
    ...
    '3': (CNN_Model_3, 'CNN_Model_3', get_optimizer_3, get_optimizer_params_3),
}
...
# Use data augmentation for model_3
if selected_model_name == 'CNN_Model_3':
    train_transform = get_train_transform()
    train_loader, test_loader = data_loader(train_mean=train_mean, train_std=train_std, batch_size_train=256, batch_size_test=2048, train_transform=train_transform)
else:
...
# Initialize scheduler for model_3
scheduler = None
if selected_model_name == 'CNN_Model_3':
    scheduler_func = get_scheduler()
    scheduler_params = get_scheduler_params()
    scheduler = scheduler_func(optimizer, **scheduler_params)
    epochs = 15
    print("Scheduler initialized for CNN_Model_3")
